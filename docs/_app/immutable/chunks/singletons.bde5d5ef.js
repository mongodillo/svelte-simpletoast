import { w as c } from './index.57e4ef2e.js';
var _;
const h = ((_ = globalThis.__sveltekit_cpzbbl) == null ? void 0 : _.base) ?? '/svelte-simpletoast';
var b;
const v = ((b = globalThis.__sveltekit_cpzbbl) == null ? void 0 : b.assets) ?? h,
	k = '1684226150836',
...
function x(e, t) {
	...
	const a = e instanceof SVGAElement ? e.target.baseVal : e.target,
		l = !n || !!a || w(n, t) || (e.getAttribute('rel') || '').split(/\s+/).includes('external'),
...
function O(e) {
	...
	for (; s && s !== document.documentElement; )
		a === null && (a = i(s, 'preload-code')),
			l === null && (l = i(s, 'preload-data')),
			t === null && (t = i(s, 'keepfocus')),
			n === null && (n = i(s, 'noscroll')),
			r === null && (r = i(s, 'reload')),
			o === null && (o = i(s, 'replacestate')),
			(s = g(s));
	return {
...
function m() {
	...
	async function a() {
		...
		try {
			...
			if (!l.ok) return !1;
			const o = (await l.json()).version !== k;
...
const L = { url: p({}), page: p({}), navigating: c(null), updated: m() };
export {
	S as I,
	f as P,
	R as S,
